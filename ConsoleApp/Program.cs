...
namespace Fabot
{
    ...
    class Config
    {
        ...
        public string botAddress { get { return Environment.GetEnvironmentVariable("BOT_ADDRESS"); ; } }
    }
    ...
    class Program
    {
        ...
        static async Task GetUpdateAsync()
        {
            ...
            var response = await client.GetAsync(string.Format(_config.botAddress + "getUpdates?offset={0}", _config.offSet));
        ...
        static async Task SendMessageAsync(TelegramChat chat, string msg)
        {
            ...
            var response = await client.PostAsync(
                _config.botAddress + "sendMessage",
